                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                />
                                {getFieldStatus("fullName") === "success" && <CheckCircle className="absolute right-3 top-2.5 w-4 h-4 text-green-500" />}
                            </div>
                            {errors.fullName && touched.fullName && <p className="text-xs text-destructive">{errors.fullName}</p>}
                        </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            />
                            {getFieldStatus("email") === "success" && <CheckCircle className="absolute right-3 top-2.5 w-4 h-4 text-green-500" />}
                        </div>
